...
class TestSaplAPIClient:
    ...
    def test_init(self):
        ...
        client = SaplAPIClient(base_url="https://test.example.com", timeout=60, max_retries=5)
    ...
    def test_fetch_normas_success(self, mock_get):
        ...
        mock_response.json.return_value = {
            "count": 2,
            "results": [
                {"id": 1, "tipo": "Lei", "numero": "123", "ano": 2020, "ementa": "Test law 1"},
                {
                    "id": 2,
                    "tipo": "Decreto",
                    "numero": "456",
    ...
    def test_user_agent_rotation(self, mock_get):
        ...
        user_agents_used = [call.kwargs.get("headers", {}).get("User-Agent") for call in calls]
