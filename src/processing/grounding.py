...
_STOPWORDS = {
    ...
    'com', 'sem', 'sob', 'sobre', 'que', 'e', 'ou', 'se', 'mas', 'como', 'ao', 'aos',
    'à', 'às', 'é', 'era', 'foi', 'são', 'ser', 'estar', 'está', 'este', 'esta', 'estes',
    'estas', 'esse', 'essa', 'esses', 'essas', 'aquele', 'aquela', 'aqueles', 'aquelas',
    'seu', 'sua', 'seus', 'suas', 'qual', 'quais', 'onde', 'quando', 'muito', 'muita',
    'mais', 'menos', 'não', 'sim', 'já', 'ainda', 'também', 'apenas', 'assim',
}
...
def evaluate_grounding(answer: str, evidence: list[dict[str, Any]]) -> dict[str, Any]:
    ...
    for claim in claims:
        ...
        claim_words = [
            w for w in re.findall(r'\b\w+\b', claim_norm)
